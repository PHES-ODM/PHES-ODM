-- ============================================================================
-- PHES-ODM v2.3.0 (archival) — PostgreSQL schema
--
...
-- was already underway. Derived from schema-postgres-v3.0.1.sql by removing
...
-- v3.0.1 lacks. Load-tested clean against a real PostgreSQL database.
--
-- The design notes below (enum strictness, missingness handling, etc.) are
-- general schema philosophy, unchanged from schema-postgres-v3.0.1.sql, and
